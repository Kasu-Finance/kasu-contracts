...
<div class="page">
    ...
    <div class="header">
        ...
        <div class="report-meta">
            ...
            <div>Financial Year ${data.taxYear}</div>
    ...
    <div class="info-grid">
        ...
        <div>
            ...
            <div class="info-row">
                ...
                <span class="info-value">01.01.${data.taxYear} &ndash; 31.12.${data.taxYear}</span>
            </div>
        </div>
    </div>
    ...
    <!-- Closing Balances -->
    <div class="section-title">Closing Position (31.12.${data.taxYear})</div>
