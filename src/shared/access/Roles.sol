...
bytes32 constant ROLE_LENDING_POOL_LOAN_MANAGER = keccak256("ROLE_LENDING_POOL_LOAN_MANAGER");
bytes32 constant ROLE_LENDING_POOL_MANAGER = keccak256("ROLE_LENDING_POOL_MANAGER");
bytes32 constant ROLE_LENDING_POOL_BORROWER = keccak256("ROLE_LENDING_POOL_BORROWER");

bytes32 constant PROTOCOL_FEE_CLAIM_CALLER = keccak256("PROTOCOL_FEE_CLAIM_CALLER");
